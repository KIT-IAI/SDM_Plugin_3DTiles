...
```
cd existing_repo
git remote add origin https://gitlab.kit.edu/kit/iai/sdm/3dtilesdownloader.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.kit.edu/kit/iai/sdm/3dtilesdownloader/-/settings/integrations)
